...
echo "9. Starship"
echo "10. Login manager (SDDM)"
echo "11. Fcitx5 input method"
echo "12. Udev rules"
echo "13. Tailscale exit node"
echo "0. GTK themes"
echo "q. Quit"
echo ""
...
case "${choice,,}" in
    ...
    10) target="sddminstall.sh" ;;
    11) target="fcitx5install.sh" ;;
    12) target="udevinstall.sh" ;;
    13) target="tailscaleinstall.sh" ;;
